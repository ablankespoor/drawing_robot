...
# Helper function - returns artcangent angle between 0...2Pi
# From https://www.marginallyclever.com/blog/2014/03/how-to-improve-the-2-axis-cnc-gcode-interpreter-to-understand-arcs/
def atan3(dy, dx):
    a = math.atan2(dy, dx)
    if a < 0:
        a = a + 2*np.pi
...
# Bits of code copied from jonathan win's gcode viewer (yagv)
# See github.com/jonathanwin/yagv
...
##        inverted_im = PIL.ImageOps.invert(rgb_im)
...
# Returns instructions list for a crosshatch shaded image.  Scale is the  number of mm per 'pixel'
# and imarray is a numpy array containing the greyscale image.
...
def main():
    ...
    if (CURRENT_OS == OS_WINDOWS):
        dirname = "C:/Users/Debra/Desktop/Wall Plotter Images/"
